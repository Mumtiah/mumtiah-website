    ...
    return(
        <>
            <Container bg="white" maxW='container.max' textAlign='' px={{ base: "16px", lg: "100px" }} py={{ base: "40px", lg: "50px" }}>
                <Text color='#002A11' fontSize={{ base:"28px", lg:"40px"}} m="4" fontWeight='700px'as='b'>Mumtiah Data Hub</Text>
                <Image width="100%" height="100%" src="/images/datahubimg.png" alt="Image Alt" mt="8"/><br/><br/>

                <Text fontWeight="400px" fontSize={{base:"14px", lg:"24px"}}>We gladly welcome you to the "Mumtiah Data Hub", the madrasah database platform for present and past students. This is to update our 
            ...
            <Box bg={"#FEFFED"} display={"flex"} flexDirection={"column"} alignItems={"center"} m={0} width="full" px={{base:"16px", lg:"100px"}}  color={"#002A11"} py={{base:"40px", lg:"90px"}}>
                ...
                <Link href="https://forms.gle/MfQgpFQSSwMZ95ZAA" isExternal colorScheme="#002A11" variant="solid" bg="#002A11" width="333px" color={"#FEFFF4"} mt={"16px"} py="12px" px="120px" textAlign={"center"} rounded={"12px"}>Click</Link>
            </Box>
        </>
    )
}